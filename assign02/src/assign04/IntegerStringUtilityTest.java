...
/**
 * Tests the IntegerStringUtility class.
 * 
...
public class IntegerStringUtilityTest {
	...
	assertThrows(ArrayIndexOutOfBoundsException.class,
		() -> IntegerStringUtility.findMax(emptyIntArray, Comparator.naturalOrder()));
    }
	...
	String[] testStrings = new String[] { "777", "777", "555", "123124", "8675309",
		"121132411324315356151462646363466" };
	IntegerStringUtility.insertionSort(testStrings, valueComparator);
	assertArrayEquals(
		new String[] { "555", "777", "777", "123124", "8675309", "121132411324315356151462646363466" },
		testStrings);
    }
	...
	String[] testStrings = new String[] { "737", "377", "555", "123124", "8675309",
		"121132411324315356151462646363466" };
	IntegerStringUtility.insertionSort(testStrings, similarityComparator);
	assertArrayEquals(
		new String[] { "737", "377", "555", "123124", "8675309", "121132411324315356151462646363466" },
		testStrings);
    }
	...
	String[] testMax = new String[] { "777", "777", "555", "123124", "8675309", "121132411324315356151462646363467",
		"121132411324315356151462646363466" };
	...
	String[] numbs = { "7", "8", "1234", "4321", "7", "4231", "12113243253454363246", "12113243253454363246",
		"12113243253454363246" };
	String[][] groupsUnderTesting = IntegerStringUtility.getSimilarityGroups(numbs);
	String[][] test = new String[][] { { "7", "7" }, { "1234", "4321", "4231" },
		{ "12113243253454363246", "12113243253454363246", "12113243253454363246" } };
	assertTrue(Arrays.deepEquals(groupsUnderTesting, test));
    }

    @Test
    void testEmptyGetSimilarityGroups() {
	String[] numbs = {};
	String[][] groupsUnderTesting = IntegerStringUtility.getSimilarityGroups(numbs);
    ...
    @Test
    void testAllEqualMaximumSimilarityGroups() {
	int[] numbs = { 4, 4, 4, 4, 4, 4, 4, 4, 4, 4 };
	String[] max = IntegerStringUtility.findMaximumSimilarityGroup(numbs);
	assertArrayEquals(max, new String[] { "4", "4", "4", "4", "4", "4", "4", "4", "4", "4" });
    }

    @Test
    void testEqualMaximumSimilarityGroups() {
	int[] numbs = { 4, 4, 4, 999, 999, 999 };
	String[] max = IntegerStringUtility.findMaximumSimilarityGroup(numbs);
	assertArrayEquals(max, new String[] { "999", "999", "999" });
    }

    @Test
    void testEmptyFindMaximumSimilarityGroups() {
	int[] numbs = {};
	String[] max = IntegerStringUtility.findMaximumSimilarityGroup(numbs);
	assertArrayEquals(max, new String[] {});
    }
